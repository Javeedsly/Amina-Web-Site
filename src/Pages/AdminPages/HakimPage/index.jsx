...
const HakimAdmin = () => {
  ...
  const [editedHakim, setEditedHakim] = useState(null);
  ...
  async function deleteHakim(id) {
    try {
      ...
      console.log(error.message);
      throw new Error("Failed to delete Hakim");
    }
  }
          ...
          <div className="userpage">
            <div className="filterDD">
              <div className="addUser">
                <button className='btn'><Link to="/admin/addHakim">Hakim əlavə et</Link></button>
              </div>
        ...
        {showModal && (
          <div className="modal">
            <div className="modal-content">
              ...
              <Formik
                initialValues={{
                  title: editedHakim.title || "",
                  position: editedHakim.position || "",
                }}
                ...
                onSubmit={(values) => {
                  ...
                  editHakim(editedHakim._id, formData);
                }}
              >
                {({ setFieldValue }) => (
                  <Form>
