...
const KomitetAdmin = () => {
  ...
  const [editedKomitet, setEditedKomitet] = useState(null);
  ...
  async function deleteKomitet(id) {
    try {
      ...
      console.log(error.message);
      throw new Error("Failed to delete Komitet");
    }
  }
        ...
        <div className="adminpage">
          <div className="userpage">
            <div className="filterDD">
              ...
              <button className='btn'><Link to="/admin/addKomitet">icraiyyə komitet əlavə et</Link></button>
            </div>
            ...
            return 0;
                      ...
                      .map((item) => (
                        <tr key={item._id}>
                          ...
                          <td>
                            <button
                              // onClick={() => deleteKomitet(item._id)}
        ...
        {showModal && (
          <div className="modal">
            <div className="modal-content">
              ...
              <Formik
                initialValues={{
                  title: editedKomitet.title || "",
                  position: editedKomitet.position || "",
                }}
                ...
                onSubmit={(values) => {
                  ...
                  editKomitet(editedKomitet._id, formData);
                }}
              >
                {({ setFieldValue }) => (
                  <Form>
