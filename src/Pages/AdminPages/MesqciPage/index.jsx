...
const MesqciAdmin = () => {
  ...
  const [editedMesqci, setEditedMesqci] = useState(null);
        ...
        <div className="adminpage">
          <div className="userpage">
            <div className="filterDD">
              ...
              <button className='btn'><Link to="/admin/addMesqci">Məşqçi əlavə et</Link></button>
            </div>
        ...
        {showModal && (
          <div className="modal">
            <div className="modal-content">
              ...
              <Formik
                initialValues={{
                  title: editedMesqci.title || "",
                  position: editedMesqci.position || "",
                }}
                ...
                onSubmit={(values) => {
                  ...
                  editMesqci(editedMesqci._id, formData);
                }}
              >
                {({ setFieldValue }) => (
                  <Form>
